...
| :--- | :--- | :--- | :--- | :--- |
| *R01* | *A03* | *System* | *Ketika penjual menambahkan data makanan pada form makanan surplus, sistem mevalidasi kelengkapan data (nama, stok, harga) dan kesesuaian data (foto berupa JPG/PNG maksimal 10 MB, harga/stok tidak negatif) lalu menampilkan ke listing secara real-time* | *Ya* |
